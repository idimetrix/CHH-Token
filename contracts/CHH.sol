 ...
 */
interface ICHHMetadata is ICHH {
    /**
...
contract Token is Context, ICHHMetadata, Ownable {
     ...
     */
    constructor() {
        _name = "Cheap Hotels Hub";
        _symbol = "CHH";
        _mint(0xF1Ee97a275ee3f36dBCEB6379bf713e1A897B515, presaleReserve);
        _mint(0xC5C394499eee03B8C4E5Df08D8Edd8657f15eADd, stakingReserve);
        _mint(0x8EdB0c04b7bEB9d951Ff4Fd483f3813AA6A80F41, projectFundReserve);
        _mint(0x7e0BE1f31aaf3ac71595c5E45AFcaed8d13D698a, liquidityReserve);
    }
